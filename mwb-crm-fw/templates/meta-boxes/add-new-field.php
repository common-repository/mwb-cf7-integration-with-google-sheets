...
<div id="mwb-add-new-field-section-wrapper"  class="mwb-feeds__content  mwb-content-wrap row-hide">
	<a class="mwb-feeds__header-link">
		<?php esc_html_e( 'Add New Field', 'mwb-cf7-integration-with-google-sheets' ); ?>
	</a>
		...
		<div class="mwb-feeds__meta-box-wrap">
			<div class="mwb-form-wrapper">
				<select id="add-new-field-select">
					<option value="-1"><?php esc_html_e( 'Select an Option', 'mwb-cf7-integration-with-google-sheets' ); ?></option>
					<?php if ( isset( $params['crm_fields']['fields'] ) ) : ?>
						<?php foreach ( $params['crm_fields']['fields'] as $key => $fields_data ) : ?>
							<?php
				...
				<a id="add-new-field-btn" class="mwb-btn mwb-btn--filled"><?php esc_html_e( 'Add Field', 'mwb-cf7-integration-with-google-sheets' ); ?></a>
			</div>
		</div>
	</div>
</div>
