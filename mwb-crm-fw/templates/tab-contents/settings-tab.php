...
<div class="mwb_cf7_integration_account-wrap">
	...
	<div class="mwb-cf7_integration_logo-wrap">
		<div class="mwb-cf7_integration_logo-crm">
			<img src="<?php echo esc_url( MWB_CF7_INTEGRATION_WITH_GSHEETS_URL . 'admin/images/crm.png' ); ?>" alt="<?php esc_html_e( 'Google Sheets', 'mwb-cf7-integration-with-google-sheets' ); ?>">
		</div>
		...
		<div class="mwb_cf7_integration_table_wrapper">
			<table class="mwb_cf7_integration_table">
				<tbody>
					...
					<tr>
						<th>
							<label><?php esc_html_e( 'Enable logs', 'mwb-cf7-integration-with-google-sheets' ); ?></label>
						</th>

						<td>
							<?php
							$desc = esc_html__( 'Enable logging of all the form data to be sent over salesforce', 'mwb-cf7-integration-with-google-sheets' );
					...
					<tr>
						<th>
							<label><?php esc_html_e( 'Plugin Data', 'mwb-cf7-integration-with-google-sheets' ); ?></label>
						</th>

						<td>
							<?php
							$desc = esc_html__( 'Enable to delete the plugin data after uninstallation of plugin', 'mwb-cf7-integration-with-google-sheets' );
							echo esc_html( $params['admin_class']::mwb_cf7_integration_tooltip( $desc ) );
					...
					<tr>
						<th>
							<label><?php esc_html_e( 'Email notification', 'mwb-cf7-integration-with-google-sheets' ); ?></label>
						</th>

						<td>
							<?php
								$desc = esc_html__( 'Enable email notification on errors while syncing data over Google Sheets.', 'mwb-cf7-integration-with-google-sheets' );
								echo esc_html( $params['admin_class']::mwb_cf7_integration_tooltip( $desc ) );
					...
					<tr>
						<th>
							<label><?php esc_html_e( 'Delete logs after N days', 'mwb-cf7-integration-with-google-sheets' ); ?></label>
						</th>

						<td>
							<?php
							$desc = esc_html__( 'This will delete the logs data after N no. of days', 'mwb-cf7-integration-with-google-sheets' );
							echo esc_html( $params['admin_class']::mwb_cf7_integration_tooltip( $desc ) );
					...
					<tr>
						...
						<td>
							<input type="submit" name="mwb_cf7_integration_submit_setting" class="mwb_cf7_integration_submit_setting" value="<?php esc_html_e( 'Save', 'mwb-cf7-integration-with-google-sheets' ); ?>" >
						</td>
					</tr>
					<!-- Save settings end -->
