...
<div id="mwb-feeds" class="mwb-cf7-integration__feedlist-wrap">
	...
	<div class="mwb-cf7_integration_logo-wrap">
		<div class="mwb-cf7_integration_logo-crm">
			<img src="<?php echo esc_url( MWB_CF7_INTEGRATION_WITH_GSHEETS_URL . 'admin/images/crm.png' ); ?>" alt="<?php esc_html_e( 'Salesforce', 'mwb-cf7-integration-with-google-sheets' ); ?>">
		</div>
		...
		<div class="mwb-cf7-integration__filterfeed">
			<Select class="filter-feeds-by-form" name="filter-feeds-by-form" >
				<option value="-1"><?php esc_html_e( 'Select CF7 form', 'mwb-cf7-integration-with-google-sheets' ); ?></option>
				<option value="all"><?php esc_html_e( 'All Feeds', 'mwb-cf7-integration-with-google-sheets' ); ?></option>
	...
	<ul class="mwb-cf7-integration__feed-list">
		<?php
		...
		foreach ( $params['feeds'] as $key => $feed ) :
			...
			$sheet          = $feed_module->get_google_sheet( $crm_object );
			...
			<li class="mwb-cf7-integration__feed-row">
				<div class="mwb-cf7-integration__left-col">
					...
					<div class="mwb-feed-status__wrap">
						<p class="mwb-feed-status-text_<?php echo esc_attr( $feed->ID ); ?>" ><strong><?php echo 'publish' == $_status ? esc_html__( 'Active', 'mwb-cf7-integration-with-google-sheets' ) : esc_html__( 'Sandbox', 'mwb-cf7-integration-with-google-sheets' ); // phpcs:ignore ?></strong></p>
					...
					<p>
						<span class="mwb-about__list-item-sub-heading"><?php esc_html_e( 'G-Sheet : ', 'mwb-cf7-integration-with-google-sheets' ); ?></span>
						<span><?php echo esc_html( $sheet ); ?></span> 
					</p>
					<p class="row-hide"> 
					...
					<p>
						...
						<span><?php echo 'yes' != $filter_applied ? esc_html__( '-', 'mwb-cf7-integration-with-google-sheets' ) : esc_html__( 'Applied', 'mwb-cf7-integration-with-google-sheets' ); // phpcs:ignore ?></span> 
					</p>
				</div>
				<div class="mwb-cf7-integration__right-col">
					<a href="<?php echo esc_url( $edit_link ); ?>">
						<img src="<?php echo esc_url( MWB_CF7_INTEGRATION_WITH_GSHEETS_URL . 'admin/images/edit.svg' ); ?>" alt="<?php esc_html_e( 'Edit feed', 'mwb-cf7-integration-with-google-sheets' ); ?>">
					</a>
	...
	<div class="mwb-about__list-item mwb-about__list-add">            
		<div class="mwb-about__list-item-btn">
			<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=mwb_' . $this->crm_slug . '_cf7' ) ); ?>" class="mwb-btn mwb-btn--filled add_new_post">
				<?php esc_html_e( 'Add Feeds', 'mwb-cf7-integration-with-google-sheets' ); ?>
			</a>
		</div>
	</div>
